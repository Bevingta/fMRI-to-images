...
for im_id in range(len(pred_vision)):
    ...
    uim = uim[:, :77].cuda(0).half() #changed by andrea. was cuda(1). Moreover, there was no [:, :77].
    ...
    x[0].save('results/versatile_diffusion_reducedbs/subj{:02d}/{}.png'.format(sub,im_id))
