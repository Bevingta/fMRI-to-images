...
with torch.no_grad():
    ...
    np.save('data/extracted_features_reducedbs/subj{:02d}/nsd_cliptext_test.npy'.format(sub),test_clip)
    ...
    np.save('data/extracted_features_reducedbs/subj{:02d}/nsd_cliptext_train.npy'.format(sub),train_clip)
