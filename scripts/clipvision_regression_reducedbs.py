...
train_clip = np.load('data/extracted_features_reducedbs/subj{:02d}/nsd_clipvision_train.npy'.format(sub))
test_clip = np.load('data/extracted_features_reducedbs/subj{:02d}/nsd_clipvision_test.npy'.format(sub))
...
np.save('data/predicted_features_reducedbs/subj{:02d}/nsd_clipvision_predtest_nsdgeneral.npy'.format(sub),pred_clip)
...
with open('data/regression_weights_reducedbs/subj{:02d}/clipvision_regression_weights.pkl'.format(sub),"wb") as f:
