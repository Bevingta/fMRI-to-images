...
np.save('data/predicted_features_reducedbs/subj{:02d}/nsd_vdvae_nsdgeneral_pred_sub{}_31l_alpha50k.npy'.format(sub,sub),pred_latents)
...
with open('data/regression_weights_reducedbs/subj{:02d}/vdvae_regression_weights.pkl'.format(sub),"wb") as f:
