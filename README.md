...
- I made a scheme that represents in a simplified way the functioning of the model, the dimensions of the data, and the code scripts related to the various steps of the model;
